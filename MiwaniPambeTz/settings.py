...
ALLOWED_HOSTS = ['*']  # means any domain name can host this website... Lets have '*' since when we deploy on free hosting providers like heroku they give us random url
...
'''
    KAKA HII NI MUHIMU SERIOUS NAKWAMBIA SAWA HII SITE YETU IPO KWENYE HOSTING BUT MWANZO ILIKUWA INAKATAAA KABISA KU-SERVER STATIC FILES CSS 
